...
export type SitePageFieldsEnum = 
  ...
  'context___tagName' |
  'context___slug' |
  'context___prev___frontmatter___slug' |
...
export type UseAllPostsQueryVariables = {};


export type UseAllPostsQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'id' | 'excerpt'>
        & { frontmatter: Maybe<(
          Pick<MdxFrontmatter, 'slug' | 'date' | 'title' | 'tags'>
          & { cover: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluid_WithWebp_TracedSvgFragment> }> }> }
        )> }
      ) }> } };

export type UseAllTagsQueryVariables = {};


export type UseAllTagsQuery = { allMdx: { edges: Array<{ node: { frontmatter: Maybe<Pick<MdxFrontmatter, 'tags'>> } }> } };

export type UseSiteBuildTimeQueryVariables = {};


export type UseSiteBuildTimeQuery = { site: Maybe<Pick<Site, 'buildTime'>> };
...
export type PostTemplateQuery = { mdx: Maybe<(
