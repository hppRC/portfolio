...
import ShaderGIF from '../../../images/gif/shader.gif';
import PhysicsGIF from '../../../images/gif/phisics.gif';
import ExperimentsGIF from '../../../images/gif/experiments.gif';
...
<ul>
    ...
    <Card to={"https://hpprc.github.io/generativereact/"}>
    ...
    <Card to={"https://twitter.com/2434illustbot"}>
        <img src={NijisanjibotPNG} alt='nijisanji illust bot' />
        <h2>2434 Illust bot</h2>
        <p>にじさんじのイラストbotです(名前のまんま)。Rustで直接Twitter APIを叩いて動かしています。アプリはherokuにデプロイされており、定期実行の機能もあります。Githubは<a href="https://github.com/hppRC/2434illustbot">こちらです。</a>たまにAPIの権限が吹っ飛ぶので定期実行できていない時があります。</p>
    </Card>
